...
--Fuel Configs here that work with the shops.
Config.MaxFuelInStation = 5000 --Maximum amount of fuel in station. works with the units to procent config
Config.ChangeUnitsToProcent = 50 -- if you change the value above MaxFuelInStation to something like 10000 make sure to change this to 100 and so on
Config.ShowDigitsAfterDecimal = 10 -- value ten means 1 number after the point example 79.53 will get 79.5 if you want more like .53 change to 100 and so on
--
...
Config.Strings = {
	DepositFuel = "Press ~g~ E ~w~ to deposit fuel",
